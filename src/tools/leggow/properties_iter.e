expanded class PROPERTIES_ITER
	-- An expanded iterator over properties of a GI_CLASS
insert GI_ITERATOR[GI_PROPERTY_INFO]
feature {ANY}
	start is
		do
			i:=gi_class.properties_lower
		end

	is_off: BOOLEAN is
		do
			Result:=i>gi_class.properties_upper
		end
