...
feature {} -- External calls
	...
	gdk_screen_get_monitor_at_point (a_screen: POINTER; a_x: INTEGER; a_y: INTEGER): INTEGER is
	...
	gdk_screen_get_monitor_at_window (a_screen: POINTER; a_window: POINTER): INTEGER is
	...
	gdk_screen_get_monitor_height_mm (a_screen: POINTER; a_monitor_num: INTEGER): INTEGER is
	...
	gdk_screen_get_monitor_plug_name (a_screen: POINTER; a_monitor_num: INTEGER): POINTER is
	...
	gdk_screen_get_monitor_width_mm (a_screen: POINTER; a_monitor_num: INTEGER): INTEGER is
	...
	gdk_screen_get_primary_monitor (a_screen: POINTER): INTEGER is
	...
	gdk_screen_get_setting (a_screen: POINTER; a_name: POINTER; a_value: POINTER): INTEGER is
	...
	gdk_screen_get_type: like long_unsigned is
 		-- gdk_screen_get_type
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_screen_set_resolution (a_screen: POINTER; a_dpi: REAL) is
