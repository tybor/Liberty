...
feature {} -- External calls
	...
	gdk_device_free_history (an_events: POINTER; a_n_events: INTEGER) is
	...
	gdk_device_get_axis (a_device: POINTER; an_axes: POINTER; an_use: INTEGER; a_value: POINTER): INTEGER is
 		-- gdk_device_get_axis
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_device_get_axis_use (a_device: POINTER; an_index: NATURAL): INTEGER is
	...
	gdk_device_get_has_cursor (a_device: POINTER): INTEGER is
	...
	gdk_device_get_history (a_device: POINTER; a_window: POINTER; a_start: NATURAL; a_stop: NATURAL; an_events: POINTER; a_n_events: POINTER): INTEGER is
	...
	gdk_device_get_key (a_device: POINTER; an_index: NATURAL; a_keyval: POINTER; a_modifiers: POINTER) is
 		-- gdk_device_get_key
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_device_get_n_axes (a_device: POINTER): INTEGER is
	...
	gdk_device_get_n_keys (a_device: POINTER): INTEGER is
	...
	gdk_device_get_type: like long_unsigned is
 		-- gdk_device_get_type
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_device_set_axis_use (a_device: POINTER; an_index: NATURAL; an_use: INTEGER) is
	...
	gdk_device_set_key (a_device: POINTER; an_index: NATURAL; a_keyval: NATURAL; a_modifiers: INTEGER) is
 		-- gdk_device_set_key
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_device_set_mode (a_device: POINTER; a_mode: INTEGER): INTEGER is
 		-- gdk_device_set_mode
		external "plug_in"
		alias "{
			location: "."
