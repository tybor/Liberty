...
feature {ANY} -- Validity
    is_valid_value (a_value: INTEGER): BOOLEAN is
        do
            Result := (a_value & (background_low_level | 
				cap_style_low_level | 
				clip_mask_low_level | 
				...
				fill_low_level | 
				font_low_level | 
				foreground_low_level | 
				function_low_level | 
				join_style_low_level | 
				...
				ts_y_origin_low_level)).to_boolean
		end
...
feature {ANY} -- Setters
	...
	set_background is
		do
			value := value.bit_or(background_low_level)
		end

	unset_background is
		do
			value := value.bit_xor(background_low_level)
		end
