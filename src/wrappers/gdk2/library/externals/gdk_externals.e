...
feature {} -- External calls
	...
	gdk_event_send_client_message (an_event: POINTER; a_winid: NATURAL): INTEGER is
	...
	gdk_event_send_client_message_for_display (a_display: POINTER; an_event: POINTER; a_winid: NATURAL): INTEGER is
	...
	gdk_init_check (an_argc: POINTER; an_argv: POINTER): INTEGER is
 		-- gdk_init_check
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_keyboard_grab (a_window: POINTER; an_owner_events: INTEGER; a_time: NATURAL): INTEGER is
 		-- gdk_keyboard_grab
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_keyboard_grab_info_libgtk_only (a_display: POINTER; a_grab_window: POINTER; an_owner_events: POINTER): INTEGER is
	...
	gdk_keyboard_ungrab (a_time: NATURAL) is
 		-- gdk_keyboard_ungrab
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_pointer_grab (a_window: POINTER; an_owner_events: INTEGER; an_event_mask: INTEGER; a_confine_to: POINTER; a_cursor: POINTER; a_time: NATURAL): INTEGER is
 		-- gdk_pointer_grab
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_pointer_grab_info_libgtk_only (a_display: POINTER; a_grab_window: POINTER; an_owner_events: POINTER): INTEGER is
	...
	gdk_pointer_ungrab (a_time: NATURAL) is
 		-- gdk_pointer_ungrab
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_rectangle_get_type: like long_unsigned is
	...
	gdk_set_double_click_time (a_msec: NATURAL) is
	...
	gdk_threads_add_idle (a_function: POINTER; a_data: POINTER): NATURAL is
	...
	gdk_threads_add_idle_full (a_priority: INTEGER; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
	...
	gdk_threads_add_timeout (an_interval: NATURAL; a_function: POINTER; a_data: POINTER): NATURAL is
	...
	gdk_threads_add_timeout_full (a_priority: INTEGER; an_interval: NATURAL; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
	...
	gdk_threads_add_timeout_seconds (an_interval: NATURAL; a_function: POINTER; a_data: POINTER): NATURAL is
	...
	gdk_threads_add_timeout_seconds_full (a_priority: INTEGER; an_interval: NATURAL; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
