...
feature {ANY} -- Validity
    is_valid_value (a_value: INTEGER): BOOLEAN is
        do
            Result := ((a_value = arrow_low_level)  or else
				...
				(a_value = cursor_is_pixmap_low_level)  or else
				...
				(a_value = x_cursor_low_level)  or else
				(a_value = xterm_low_level) )
		end
...
feature {ANY} -- Queries
	...
	is_based_arrow_down: BOOLEAN is
		do
			Result := (value=based_arrow_down_low_level)
		end

	is_based_arrow_up: BOOLEAN is
		do
			Result := (value=based_arrow_up_low_level)
		end

	is_blank_cursor: BOOLEAN is
		do
	...
	is_cross_reverse: BOOLEAN is
		do
			Result := (value=cross_reverse_low_level)
		end

	is_crosshair: BOOLEAN is
		do
			Result := (value=crosshair_low_level)
		end

	is_cursor_is_pixmap: BOOLEAN is
		do
			Result := (value=cursor_is_pixmap_low_level)
		end

	is_diamond_cross: BOOLEAN is
		do
	...
	is_pencil: BOOLEAN is
		do
			Result := (value=pencil_low_level)
		end

	is_pirate: BOOLEAN is
		do
	...
	is_ul_angle: BOOLEAN is
		do
			Result := (value=ul_angle_low_level)
		end

	is_umbrella: BOOLEAN is
		do
			Result := (value=umbrella_low_level)
		end

	is_ur_angle: BOOLEAN is
		do
