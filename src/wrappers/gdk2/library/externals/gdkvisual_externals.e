...
feature {} -- External calls
	...
	gdk_visual_get_bits_per_rgb (a_visual: POINTER): INTEGER is
	...
	gdk_visual_get_colormap_size (a_visual: POINTER): INTEGER is
	...
	gdk_visual_get_depth (a_visual: POINTER): INTEGER is
	...
	gdk_visual_get_type: like long_unsigned is
 		-- gdk_visual_get_type
		external "plug_in"
		alias "{
			location: "."
