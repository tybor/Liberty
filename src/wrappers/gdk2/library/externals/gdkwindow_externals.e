...
feature {} -- External calls
	...
	gdk_window_begin_move_drag (a_window: POINTER; a_button: INTEGER; a_root_x: INTEGER; a_root_y: INTEGER; a_timestamp: NATURAL) is
	...
	gdk_window_begin_resize_drag (a_window: POINTER; an_edge: INTEGER; a_button: INTEGER; a_root_x: INTEGER; a_root_y: INTEGER; a_timestamp: NATURAL) is
	...
	gdk_window_constrain_size (a_geometry: POINTER; a_flags: NATURAL; a_width: INTEGER; a_height: INTEGER; a_new_width: POINTER; a_new_height: POINTER) is
	...
	gdk_window_coords_from_parent (a_window: POINTER; a_parent_x: REAL; a_parent_y: REAL; a_x: POINTER; a_y: POINTER) is
	...
	gdk_window_coords_to_parent (a_window: POINTER; a_x: REAL; a_y: REAL; a_parent_x: POINTER; a_parent_y: POINTER) is
	...
	gdk_window_create_similar_surface (a_window: POINTER; a_content: INTEGER; a_width: INTEGER; a_height: INTEGER): POINTER is
	...
	gdk_window_ensure_native (a_window: POINTER): INTEGER is
	...
	gdk_window_focus (a_window: POINTER; a_timestamp: NATURAL) is
 		-- gdk_window_focus
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_window_get_accept_focus (a_window: POINTER): INTEGER is
	...
	gdk_window_get_composited (a_window: POINTER): INTEGER is
	...
	gdk_window_get_decorations (a_window: POINTER; a_decorations: POINTER): INTEGER is
	...
	gdk_window_get_focus_on_map (a_window: POINTER): INTEGER is
	...
	gdk_window_get_height (a_window: POINTER): INTEGER is
	...
	gdk_window_get_modal_hint (a_window: POINTER): INTEGER is
	...
	gdk_window_get_root_coords (a_window: POINTER; a_x: INTEGER; a_y: INTEGER; a_root_x: POINTER; a_root_y: POINTER) is
	...
	gdk_window_get_width (a_window: POINTER): INTEGER is
	...
	gdk_window_has_native (a_window: POINTER): INTEGER is
	...
	gdk_window_input_shape_combine_mask (a_window: POINTER; a_mask: POINTER; a_x: INTEGER; a_y: INTEGER) is
	...
	gdk_window_input_shape_combine_region (a_window: POINTER; a_shape_region: POINTER; an_offset_x: INTEGER; an_offset_y: INTEGER) is
	...
	gdk_window_invalidate_rect (a_window: POINTER; a_rect: POINTER; an_invalidate_children: INTEGER) is
	...
	gdk_window_invalidate_region (a_window: POINTER; a_region: POINTER; an_invalidate_children: INTEGER) is
	...
	gdk_window_is_destroyed (a_window: POINTER): INTEGER is
	...
	gdk_window_is_input_only (a_window: POINTER): INTEGER is
	...
	gdk_window_is_shaped (a_window: POINTER): INTEGER is
	...
	gdk_window_move_region (a_window: POINTER; a_region: POINTER; a_dx: INTEGER; a_dy: INTEGER) is
	...
	gdk_window_new (a_parent: POINTER; an_attributes: POINTER; an_attributes_mask: INTEGER): POINTER is
 		-- gdk_window_new
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_window_object_get_type: like long_unsigned is
	...
	gdk_window_process_updates (a_window: POINTER; an_update_children: INTEGER) is
	...
	gdk_window_redirect_to_drawable (a_window: POINTER; a_drawable: POINTER; a_src_x: INTEGER; a_src_y: INTEGER; a_dest_x: INTEGER; a_dest_y: INTEGER; a_width: INTEGER; a_height: INTEGER) is
	...
	gdk_window_restack (a_window: POINTER; a_sibling: POINTER; an_above: INTEGER) is
 		-- gdk_window_restack
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_window_scroll (a_window: POINTER; a_dx: INTEGER; a_dy: INTEGER) is
 		-- gdk_window_scroll
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_window_set_accept_focus (a_window: POINTER; an_accept_focus: INTEGER) is
	...
	gdk_window_set_composited (a_window: POINTER; a_composited: INTEGER) is
	...
	gdk_window_set_debug_updates (a_setting: INTEGER) is
	...
	gdk_window_set_focus_on_map (a_window: POINTER; a_focus_on_map: INTEGER) is
	...
	gdk_window_set_modal_hint (a_window: POINTER; a_modal: INTEGER) is
	...
	gdk_window_set_opacity (a_window: POINTER; an_opacity: REAL) is
	...
	gdk_window_set_override_redirect (a_window: POINTER; an_override_redirect: INTEGER) is
	...
	gdk_window_set_skip_pager_hint (a_window: POINTER; a_skips_pager: INTEGER) is
	...
	gdk_window_set_skip_taskbar_hint (a_window: POINTER; a_skips_taskbar: INTEGER) is
	...
	gdk_window_set_static_gravities (a_window: POINTER; an_use_static: INTEGER): INTEGER is
	...
	gdk_window_set_urgency_hint (a_window: POINTER; an_urgent: INTEGER) is
	...
	gdk_window_shape_combine_mask (a_window: POINTER; a_mask: POINTER; a_x: INTEGER; a_y: INTEGER) is
	...
	gdk_window_shape_combine_region (a_window: POINTER; a_shape_region: POINTER; an_offset_x: INTEGER; an_offset_y: INTEGER) is
