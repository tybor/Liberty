...
feature {} -- External calls
	...
	gdk_selection_convert (a_requestor: POINTER; a_selection: POINTER; a_target: POINTER; a_time: NATURAL) is
	...
	gdk_selection_owner_set (an_owner: POINTER; a_selection: POINTER; a_time: NATURAL; a_send_event: INTEGER): INTEGER is
	...
	gdk_selection_owner_set_for_display (a_display: POINTER; an_owner: POINTER; a_selection: POINTER; a_time: NATURAL; a_send_event: INTEGER): INTEGER is
	...
	gdk_selection_send_notify (a_requestor: NATURAL; a_selection: POINTER; a_target: POINTER; a_property: POINTER; a_time: NATURAL) is
	...
	gdk_selection_send_notify_for_display (a_display: POINTER; a_requestor: NATURAL; a_selection: POINTER; a_target: POINTER; a_property: POINTER; a_time: NATURAL) is
