...
feature {} -- External calls
	...
	gdk_event_get_axis (an_event: POINTER; an_axis_use: INTEGER; a_value: POINTER): INTEGER is
 		-- gdk_event_get_axis
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_event_get_coords (an_event: POINTER; a_x_win: POINTER; a_y_win: POINTER): INTEGER is
	...
	gdk_event_get_root_coords (an_event: POINTER; a_x_root: POINTER; a_y_root: POINTER): INTEGER is
	...
	gdk_event_get_state (an_event: POINTER; a_state: POINTER): INTEGER is
 		-- gdk_event_get_state
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_event_get_time (an_event: POINTER): NATURAL is
 		-- gdk_event_get_time
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_event_get_type: like long_unsigned is
 		-- gdk_event_get_type
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_setting_get (a_name: POINTER; a_value: POINTER): INTEGER is
 		-- gdk_setting_get
		external "plug_in"
		alias "{
			location: "."
