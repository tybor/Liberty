...
feature {} -- External calls
	...
	gdk_region_empty (a_region: POINTER): INTEGER is
 		-- gdk_region_empty
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_region_equal (a_region1: POINTER; a_region2: POINTER): INTEGER is
 		-- gdk_region_equal
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_region_point_in (a_region: POINTER; a_x: INTEGER; a_y: INTEGER): INTEGER is
 		-- gdk_region_point_in
		external "plug_in"
		alias "{
			location: "."
