...
feature {} -- External calls
	...
	gdk_drag_abort (a_context: POINTER; a_time: NATURAL) is
 		-- gdk_drag_abort
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_drag_context_get_type: like long_unsigned is
	...
	gdk_drag_drop (a_context: POINTER; a_time: NATURAL) is
 		-- gdk_drag_drop
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_drag_drop_succeeded (a_context: POINTER): INTEGER is
	...
	gdk_drag_find_window_for_screen (a_context: POINTER; a_drag_window: POINTER; a_screen: POINTER; a_x_root: INTEGER; a_y_root: INTEGER; a_dest_window: POINTER; a_protocol: POINTER) is
	...
	gdk_drag_get_protocol_for_display (a_display: POINTER; a_xid: NATURAL; a_protocol: POINTER): NATURAL is
	...
	gdk_drag_motion (a_context: POINTER; a_dest_window: POINTER; a_protocol: INTEGER; a_x_root: INTEGER; a_y_root: INTEGER; a_suggested_action: INTEGER; a_possible_actions: INTEGER; a_time: NATURAL): INTEGER is
 		-- gdk_drag_motion
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_drag_status (a_context: POINTER; an_action: INTEGER; a_time: NATURAL) is
 		-- gdk_drag_status
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_drop_finish (a_context: POINTER; a_success: INTEGER; a_time: NATURAL) is
 		-- gdk_drop_finish
		external "plug_in"
		alias "{
			location: "."
	...
	gdk_drop_reply (a_context: POINTER; an_ok: INTEGER; a_time: NATURAL) is
 		-- gdk_drop_reply
		external "plug_in"
		alias "{
			location: "."
