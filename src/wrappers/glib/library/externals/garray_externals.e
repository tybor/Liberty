...
feature {} -- External calls
	...
	g_array_free (an_array: POINTER; a_free_segment: INTEGER): POINTER is
 		-- g_array_free
		external "plug_in"
		alias "{
			location: "."
	...
	g_array_get_element_size (an_array: POINTER): NATURAL is
	...
	g_array_insert_vals (an_array: POINTER; an_index: NATURAL; a_data: POINTER; a_len: NATURAL): POINTER is
 		-- g_array_insert_vals
		external "plug_in"
		alias "{
			location: "."
	...
	g_array_new (a_zero_terminated: INTEGER; a_clear: INTEGER; an_element_size: NATURAL): POINTER is
 		-- g_array_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_array_prepend_vals (an_array: POINTER; a_data: POINTER; a_len: NATURAL): POINTER is
	...
	g_array_remove_index (an_array: POINTER; an_index: NATURAL): POINTER is
	...
	g_array_remove_index_fast (an_array: POINTER; an_index: NATURAL): POINTER is
	...
	g_array_remove_range (an_array: POINTER; an_index: NATURAL; a_length: NATURAL): POINTER is
	...
	g_array_set_clear_func (an_array: POINTER; a_clear_func: POINTER) is
	...
	g_array_set_size (an_array: POINTER; a_length: NATURAL): POINTER is
 		-- g_array_set_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_array_sized_new (a_zero_terminated: INTEGER; a_clear: INTEGER; an_element_size: NATURAL; a_reserved_size: NATURAL): POINTER is
 		-- g_array_sized_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_byte_array_append (an_array: POINTER; a_data: POINTER; a_len: NATURAL): POINTER is
 		-- g_byte_array_append
		external "plug_in"
		alias "{
			location: "."
	...
	g_byte_array_free (an_array: POINTER; a_free_segment: INTEGER): POINTER is
 		-- g_byte_array_free
		external "plug_in"
		alias "{
			location: "."
	...
	g_byte_array_free_to_bytes (an_array: POINTER): POINTER is
	...
	g_byte_array_new_take (a_data: POINTER; a_len: NATURAL): POINTER is
	...
	g_byte_array_prepend (an_array: POINTER; a_data: POINTER; a_len: NATURAL): POINTER is
	...
	g_byte_array_remove_index (an_array: POINTER; an_index: NATURAL): POINTER is
	...
	g_byte_array_remove_index_fast (an_array: POINTER; an_index: NATURAL): POINTER is
	...
	g_byte_array_remove_range (an_array: POINTER; an_index: NATURAL; a_length: NATURAL): POINTER is
	...
	g_byte_array_set_size (an_array: POINTER; a_length: NATURAL): POINTER is
	...
	g_byte_array_sized_new (a_reserved_size: NATURAL): POINTER is
	...
	g_ptr_array_free (an_array: POINTER; a_free_seg: INTEGER): POINTER is
 		-- g_ptr_array_free
		external "plug_in"
		alias "{
			location: "."
	...
	g_ptr_array_new_full (a_reserved_size: NATURAL; an_element_free_func: POINTER): POINTER is
	...
	g_ptr_array_remove (an_array: POINTER; a_data: POINTER): INTEGER is
 		-- g_ptr_array_remove
		external "plug_in"
		alias "{
			location: "."
	...
	g_ptr_array_remove_fast (an_array: POINTER; a_data: POINTER): INTEGER is
	...
	g_ptr_array_remove_index (an_array: POINTER; an_index: NATURAL): POINTER is
	...
	g_ptr_array_remove_index_fast (an_array: POINTER; an_index: NATURAL): POINTER is
	...
	g_ptr_array_remove_range (an_array: POINTER; an_index: NATURAL; a_length: NATURAL) is
	...
	g_ptr_array_set_size (an_array: POINTER; a_length: INTEGER) is
	...
	g_ptr_array_sized_new (a_reserved_size: NATURAL): POINTER is
