...
feature {} -- Low-level setters
	...
	ghook_list_struct_set_seq_id (a_structure: POINTER; a_value: like long_unsigned) is
	...
	ghook_list_struct_set_hook_size (a_structure: POINTER; a_value: NATURAL) is
	...
	ghook_list_struct_set_is_setup (a_structure: POINTER; a_value: NATURAL) is
...
feature {} -- Low-level queries
	...
	ghook_list_struct_get_seq_id (a_structure: POINTER): like long_unsigned is
	...
	ghook_list_struct_get_hook_size (a_structure: POINTER): NATURAL is
	...
	ghook_list_struct_get_is_setup (a_structure: POINTER): NATURAL is
