...
feature {} -- Low-level setters
	...
	gtest_config_struct_set_test_initialized (a_structure: POINTER; a_value: INTEGER) is
	...
	gtest_config_struct_set_test_quick (a_structure: POINTER; a_value: INTEGER) is
	...
	gtest_config_struct_set_test_perf (a_structure: POINTER; a_value: INTEGER) is
	...
	gtest_config_struct_set_test_verbose (a_structure: POINTER; a_value: INTEGER) is
	...
	gtest_config_struct_set_test_quiet (a_structure: POINTER; a_value: INTEGER) is
	...
	gtest_config_struct_set_test_undefined (a_structure: POINTER; a_value: INTEGER) is
...
feature {} -- Low-level queries
	...
	gtest_config_struct_get_test_initialized (a_structure: POINTER): INTEGER is
	...
	gtest_config_struct_get_test_quick (a_structure: POINTER): INTEGER is
	...
	gtest_config_struct_get_test_perf (a_structure: POINTER): INTEGER is
	...
	gtest_config_struct_get_test_verbose (a_structure: POINTER): INTEGER is
	...
	gtest_config_struct_get_test_quiet (a_structure: POINTER): INTEGER is
	...
	gtest_config_struct_get_test_undefined (a_structure: POINTER): INTEGER is
