...
feature {} -- External calls
	...
	g_time_zone_find_interval (a_tz: POINTER; a_type: INTEGER; a_time: INTEGER_64): INTEGER is
	...
	g_time_zone_get_abbreviation (a_tz: POINTER; an_interval: INTEGER): POINTER is
	...
	g_time_zone_get_offset (a_tz: POINTER; an_interval: INTEGER): INTEGER is
	...
	g_time_zone_is_dst (a_tz: POINTER; an_interval: INTEGER): INTEGER is
 		-- g_time_zone_is_dst
		external "plug_in"
		alias "{
			location: "."
	...
	g_time_zone_new (an_identifier: POINTER): POINTER is
 		-- g_time_zone_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_time_zone_new_local: POINTER is
	...
	g_time_zone_new_utc: POINTER is
 		-- g_time_zone_new_utc
		external "plug_in"
		alias "{
			location: "."
	...
	g_time_zone_ref (a_tz: POINTER): POINTER is
 		-- g_time_zone_ref
		external "plug_in"
		alias "{
			location: "."
	...
	g_time_zone_unref (a_tz: POINTER) is
 		-- g_time_zone_unref
		external "plug_in"
		alias "{
			location: "."
