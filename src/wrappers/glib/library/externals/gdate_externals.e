...
feature {} -- External calls
	...
	g_date_add_months (a_date: POINTER; a_n_months: NATURAL) is
 		-- g_date_add_months
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_add_years (a_date: POINTER; a_n_years: NATURAL) is
 		-- g_date_add_years
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_clear (a_date: POINTER; a_n_dates: NATURAL) is
 		-- g_date_clear
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_days_between (a_date1: POINTER; a_date2: POINTER): INTEGER is
 		-- g_date_days_between
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_get_day_of_year (a_date: POINTER): NATURAL is
	...
	g_date_get_iso8601_week_of_year (a_date: POINTER): NATURAL is
	...
	g_date_get_julian (a_date: POINTER): NATURAL is
 		-- g_date_get_julian
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_get_monday_week_of_year (a_date: POINTER): NATURAL is
	...
	g_date_get_sunday_week_of_year (a_date: POINTER): NATURAL is
	...
	g_date_is_first_of_month (a_date: POINTER): INTEGER is
	...
	g_date_is_last_of_month (a_date: POINTER): INTEGER is
	...
	g_date_is_leap_year (a_year: NATURAL_16): INTEGER is
 		-- g_date_is_leap_year
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_new_julian (a_julian_day: NATURAL): POINTER is
 		-- g_date_new_julian
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_set_julian (a_date: POINTER; a_julian_date: NATURAL) is
 		-- g_date_set_julian
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_set_time_t (a_date: POINTER; a_timet: like long) is
 		-- g_date_set_time_t
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_strftime (a_s: POINTER; a_slen: NATURAL; a_format: POINTER; a_date: POINTER): NATURAL is
 		-- g_date_strftime
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_subtract_days (a_date: POINTER; a_n_days: NATURAL) is
	...
	g_date_subtract_months (a_date: POINTER; a_n_months: NATURAL) is
	...
	g_date_subtract_years (a_date: POINTER; a_n_years: NATURAL) is
	...
	g_date_valid (a_date: POINTER): INTEGER is
 		-- g_date_valid
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_valid_day (a_day: CHARACTER): INTEGER is
 		-- g_date_valid_day
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_valid_dmy (a_day: CHARACTER; a_month: INTEGER; a_year: NATURAL_16): INTEGER is
 		-- g_date_valid_dmy
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_valid_julian (a_julian_date: NATURAL): INTEGER is
 		-- g_date_valid_julian
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_valid_month (a_month: INTEGER): INTEGER is
 		-- g_date_valid_month
		external "plug_in"
		alias "{
			location: "."
	...
	g_date_valid_weekday (a_weekday: INTEGER): INTEGER is
	...
	g_date_valid_year (a_year: NATURAL_16): INTEGER is
 		-- g_date_valid_year
		external "plug_in"
		alias "{
			location: "."
