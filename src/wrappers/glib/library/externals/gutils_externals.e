...
feature {} -- External calls
	...
	g_bit_nth_lsf (a_mask: like long_unsigned; a_nth_bit: INTEGER): INTEGER is
 		-- g_bit_nth_lsf
		external "plug_in"
		alias "{
			location: "."
	...
	g_bit_nth_msf (a_mask: like long_unsigned; a_nth_bit: INTEGER): INTEGER is
 		-- g_bit_nth_msf
		external "plug_in"
		alias "{
			location: "."
	...
	g_bit_storage (a_number: like long_unsigned): NATURAL is
 		-- g_bit_storage
		external "plug_in"
		alias "{
			location: "."
	...
	g_parse_debug_string (a_string: POINTER; a_keys: POINTER; a_nkeys: NATURAL): NATURAL is
	...
	g_snprintf (a_string: POINTER; a_n: like long_unsigned; a_format: POINTER): INTEGER is
	...
	g_vsnprintf (a_string: POINTER; a_n: like long_unsigned; a_format: POINTER; an_args: POINTER): INTEGER is
 		-- g_vsnprintf
		external "plug_in"
		alias "{
			location: "."
