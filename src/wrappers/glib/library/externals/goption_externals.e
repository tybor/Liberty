...
feature {} -- External calls
	...
	g_option_context_get_help (a_context: POINTER; a_main_help: INTEGER; a_group: POINTER): POINTER is
	...
	g_option_context_parse (a_context: POINTER; an_argc: POINTER; an_argv: POINTER; an_error: POINTER): INTEGER is
	...
	g_option_context_set_help_enabled (a_context: POINTER; a_help_enabled: INTEGER) is
	...
	g_option_context_set_ignore_unknown_options (a_context: POINTER; an_ignore_unknown: INTEGER) is
	...
	g_option_error_quark: NATURAL is
