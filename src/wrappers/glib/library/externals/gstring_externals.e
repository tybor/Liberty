...
feature {} -- External calls
	...
	g_string_append_len (a_string: POINTER; a_val: POINTER; a_len: INTEGER): POINTER is
 		-- g_string_append_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_append_unichar (a_string: POINTER; a_wc: NATURAL): POINTER is
	...
	g_string_append_uri_escaped (a_string: POINTER; an_unescaped: POINTER; a_reserved_chars_allowed: POINTER; an_allow_utf8: INTEGER): POINTER is
	...
	g_string_equal (a_v: POINTER; a_v2: POINTER): INTEGER is
 		-- g_string_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_free (a_string: POINTER; a_free_segment: INTEGER): POINTER is
 		-- g_string_free
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_free_to_bytes (a_string: POINTER): POINTER is
	...
	g_string_hash (a_str: POINTER): NATURAL is
 		-- g_string_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert_c (a_string: POINTER; a_pos: INTEGER; a_c: CHARACTER): POINTER is
 		-- g_string_insert_c
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert_len (a_string: POINTER; a_pos: INTEGER; a_val: POINTER; a_len: INTEGER): POINTER is
 		-- g_string_insert_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert_unichar (a_string: POINTER; a_pos: INTEGER; a_wc: NATURAL): POINTER is
	...
	g_string_new_len (an_init: POINTER; a_len: INTEGER): POINTER is
 		-- g_string_new_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_overwrite (a_string: POINTER; a_pos: NATURAL; a_val: POINTER): POINTER is
 		-- g_string_overwrite
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_overwrite_len (a_string: POINTER; a_pos: NATURAL; a_val: POINTER; a_len: INTEGER): POINTER is
	...
	g_string_prepend_len (a_string: POINTER; a_val: POINTER; a_len: INTEGER): POINTER is
	...
	g_string_prepend_unichar (a_string: POINTER; a_wc: NATURAL): POINTER is
	...
	g_string_set_size (a_string: POINTER; a_len: NATURAL): POINTER is
 		-- g_string_set_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_sized_new (a_dfl_size: NATURAL): POINTER is
 		-- g_string_sized_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_truncate (a_string: POINTER; a_len: NATURAL): POINTER is
 		-- g_string_truncate
		external "plug_in"
		alias "{
			location: "."
