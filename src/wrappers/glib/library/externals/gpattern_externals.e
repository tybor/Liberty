...
feature {} -- External calls
	...
	g_pattern_match_simple (a_pattern: POINTER; a_string: POINTER): INTEGER is
	...
	g_pattern_match_string (a_pspec: POINTER; a_string: POINTER): INTEGER is
	...
	g_pattern_spec_equal (a_pspec1: POINTER; a_pspec2: POINTER): INTEGER is
