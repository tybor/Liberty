...
feature {} -- External calls
	...
	set_glib_binary_age (a_value: NATURAL) is
	...
	glib_check_version (a_required_major: NATURAL; a_required_minor: NATURAL; a_required_micro: NATURAL): POINTER is
 		-- glib_check_version
		external "plug_in"
		alias "{
			location: "."
	...
	set_glib_interface_age (a_value: NATURAL) is
	...
	set_glib_major_version (a_value: NATURAL) is
	...
	set_glib_micro_version (a_value: NATURAL) is
	...
	set_glib_minor_version (a_value: NATURAL) is
