...
feature {} -- Low-level setters
	...
	gerror_struct_set_domain (a_structure: POINTER; a_value: NATURAL) is
	...
	gerror_struct_set_code (a_structure: POINTER; a_value: INTEGER) is
...
feature {} -- Low-level queries
	...
	gerror_struct_get_domain (a_structure: POINTER): NATURAL is
	...
	gerror_struct_get_code (a_structure: POINTER): INTEGER is
