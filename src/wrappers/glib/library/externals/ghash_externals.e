...
feature {} -- External calls
	...
	g_direct_equal (a_v1: POINTER; a_v2: POINTER): INTEGER is
 		-- g_direct_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_direct_hash (a_v: POINTER): NATURAL is
 		-- g_direct_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_double_equal (a_v1: POINTER; a_v2: POINTER): INTEGER is
 		-- g_double_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_double_hash (a_v: POINTER): NATURAL is
 		-- g_double_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_hash_table_add (a_hash_table: POINTER; a_key: POINTER) is
 		-- g_hash_table_add
		external "plug_in"
		alias "{
			location: "."
	...
	g_hash_table_contains (a_hash_table: POINTER; a_key: POINTER): INTEGER is
	...
	g_hash_table_foreach_remove (a_hash_table: POINTER; a_func: POINTER; an_user_data: POINTER): NATURAL is
	...
	g_hash_table_foreach_steal (a_hash_table: POINTER; a_func: POINTER; an_user_data: POINTER): NATURAL is
	...
	g_hash_table_iter_next (an_iter: POINTER; a_key: POINTER; a_value: POINTER): INTEGER is
	...
	g_hash_table_iter_replace (an_iter: POINTER; a_value: POINTER) is
	...
	g_hash_table_lookup_extended (a_hash_table: POINTER; a_lookup_key: POINTER; an_orig_key: POINTER; a_value: POINTER): INTEGER is
	...
	g_hash_table_remove (a_hash_table: POINTER; a_key: POINTER): INTEGER is
 		-- g_hash_table_remove
		external "plug_in"
		alias "{
			location: "."
	...
	g_hash_table_size (a_hash_table: POINTER): NATURAL is
 		-- g_hash_table_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_hash_table_steal (a_hash_table: POINTER; a_key: POINTER): INTEGER is
 		-- g_hash_table_steal
		external "plug_in"
		alias "{
			location: "."
	...
	g_int64_equal (a_v1: POINTER; a_v2: POINTER): INTEGER is
 		-- g_int64_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_int64_hash (a_v: POINTER): NATURAL is
 		-- g_int64_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_int_equal (a_v1: POINTER; a_v2: POINTER): INTEGER is
 		-- g_int_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_int_hash (a_v: POINTER): NATURAL is
 		-- g_int_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_str_equal (a_v1: POINTER; a_v2: POINTER): INTEGER is
 		-- g_str_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_str_hash (a_v: POINTER): NATURAL is
 		-- g_str_hash
		external "plug_in"
		alias "{
			location: "."
