...
feature {} -- External calls
	...
	g_markup_error_quark: NATURAL is
	...
	g_markup_escape_text (a_text: POINTER; a_length: INTEGER): POINTER is
	...
	g_markup_parse_context_end_parse (a_context: POINTER; an_error: POINTER): INTEGER is
	...
	g_markup_parse_context_parse (a_context: POINTER; a_text: POINTER; a_text_len: INTEGER; an_error: POINTER): INTEGER is
