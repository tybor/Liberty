...
feature {} -- External calls
	...
	g_hostname_is_ascii_encoded (a_hostname: POINTER): INTEGER is
	...
	g_hostname_is_ip_address (a_hostname: POINTER): INTEGER is
	...
	g_hostname_is_non_ascii (a_hostname: POINTER): INTEGER is
