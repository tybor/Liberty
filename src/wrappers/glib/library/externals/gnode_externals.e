...
feature {} -- External calls
	...
	g_node_depth (a_node: POINTER): NATURAL is
 		-- g_node_depth
		external "plug_in"
		alias "{
			location: "."
	...
	g_node_is_ancestor (a_node: POINTER; a_descendant: POINTER): INTEGER is
 		-- g_node_is_ancestor
		external "plug_in"
		alias "{
			location: "."
	...
	g_node_max_height (a_root: POINTER): NATURAL is
 		-- g_node_max_height
		external "plug_in"
		alias "{
			location: "."
	...
	g_node_n_children (a_node: POINTER): NATURAL is
 		-- g_node_n_children
		external "plug_in"
		alias "{
			location: "."
	...
	g_node_n_nodes (a_root: POINTER; a_flags: INTEGER): NATURAL is
 		-- g_node_n_nodes
		external "plug_in"
		alias "{
			location: "."
	...
	g_node_nth_child (a_node: POINTER; a_n: NATURAL): POINTER is
 		-- g_node_nth_child
		external "plug_in"
		alias "{
			location: "."
	...
	g_node_traverse (a_root: POINTER; an_order: INTEGER; a_flags: INTEGER; a_max_depth: INTEGER; a_func: POINTER; a_data: POINTER) is
 		-- g_node_traverse
		external "plug_in"
		alias "{
			location: "."
