...
feature {} -- External calls
	...
	g_error_matches (an_error: POINTER; a_domain: NATURAL; a_code: INTEGER): INTEGER is
 		-- g_error_matches
		external "plug_in"
		alias "{
			location: "."
	...
	g_error_new (a_domain: NATURAL; a_code: INTEGER; a_format: POINTER): POINTER is
	...
	g_error_new_literal (a_domain: NATURAL; a_code: INTEGER; a_message: POINTER): POINTER is
 		-- g_error_new_literal
		external "plug_in"
		alias "{
			location: "."
	...
	g_error_new_valist (a_domain: NATURAL; a_code: INTEGER; a_format: POINTER; an_args: POINTER): POINTER is
 		-- g_error_new_valist
		external "plug_in"
		alias "{
			location: "."
	...
	g_set_error (an_err: POINTER; a_domain: NATURAL; a_code: INTEGER; a_format: POINTER) is
	...
	g_set_error_literal (an_err: POINTER; a_domain: NATURAL; a_code: INTEGER; a_message: POINTER) is
 		-- g_set_error_literal
		external "plug_in"
		alias "{
			location: "."
