...
feature {} -- External calls
	...
	g_bookmark_file_error_quark: NATURAL is
	...
	g_bookmark_file_get_added (a_bookmark: POINTER; an_uri: POINTER; an_error: POINTER): like long is
	...
	g_bookmark_file_get_app_info (a_bookmark: POINTER; an_uri: POINTER; a_name: POINTER; an_exec: POINTER; a_count: POINTER; a_stamp: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_get_icon (a_bookmark: POINTER; an_uri: POINTER; a_href: POINTER; a_mime_type: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_get_is_private (a_bookmark: POINTER; an_uri: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_get_modified (a_bookmark: POINTER; an_uri: POINTER; an_error: POINTER): like long is
	...
	g_bookmark_file_get_size (a_bookmark: POINTER): INTEGER is
	...
	g_bookmark_file_get_visited (a_bookmark: POINTER; an_uri: POINTER; an_error: POINTER): like long is
	...
	g_bookmark_file_has_application (a_bookmark: POINTER; an_uri: POINTER; a_name: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_has_group (a_bookmark: POINTER; an_uri: POINTER; a_group: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_has_item (a_bookmark: POINTER; an_uri: POINTER): INTEGER is
	...
	g_bookmark_file_load_from_data (a_bookmark: POINTER; a_data: POINTER; a_length: NATURAL; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_load_from_data_dirs (a_bookmark: POINTER; a_file: POINTER; a_full_path: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_load_from_file (a_bookmark: POINTER; a_filename: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_move_item (a_bookmark: POINTER; an_old_uri: POINTER; a_new_uri: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_remove_application (a_bookmark: POINTER; an_uri: POINTER; a_name: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_remove_group (a_bookmark: POINTER; an_uri: POINTER; a_group: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_remove_item (a_bookmark: POINTER; an_uri: POINTER; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_set_added (a_bookmark: POINTER; an_uri: POINTER; an_added: like long) is
	...
	g_bookmark_file_set_app_info (a_bookmark: POINTER; an_uri: POINTER; a_name: POINTER; an_exec: POINTER; a_count: INTEGER; a_stamp: like long; an_error: POINTER): INTEGER is
	...
	g_bookmark_file_set_groups (a_bookmark: POINTER; an_uri: POINTER; a_groups: POINTER; a_length: NATURAL) is
	...
	g_bookmark_file_set_is_private (a_bookmark: POINTER; an_uri: POINTER; an_is_private: INTEGER) is
	...
	g_bookmark_file_set_modified (a_bookmark: POINTER; an_uri: POINTER; a_modified: like long) is
	...
	g_bookmark_file_set_visited (a_bookmark: POINTER; an_uri: POINTER; a_visited: like long) is
	...
	g_bookmark_file_to_file (a_bookmark: POINTER; a_filename: POINTER; an_error: POINTER): INTEGER is
