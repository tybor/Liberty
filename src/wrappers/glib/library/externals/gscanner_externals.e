...
feature {} -- External calls
	...
	g_scanner_cur_line (a_scanner: POINTER): NATURAL is
 		-- g_scanner_cur_line
		external "plug_in"
		alias "{
			location: "."
	...
	g_scanner_cur_position (a_scanner: POINTER): NATURAL is
	...
	-- function g_scanner_cur_value (at line 226 in file /usr/include/glib-2.0/glib/gscanner.h is not wrappable
	...
	g_scanner_eof (a_scanner: POINTER): INTEGER is
 		-- g_scanner_eof
		external "plug_in"
		alias "{
			location: "."
	...
	g_scanner_input_file (a_scanner: POINTER; an_input_fd: INTEGER) is
	...
	g_scanner_input_text (a_scanner: POINTER; a_text: POINTER; a_text_len: NATURAL) is
	...
	g_scanner_scope_add_symbol (a_scanner: POINTER; a_scope_id: NATURAL; a_symbol: POINTER; a_value: POINTER) is
	...
	g_scanner_scope_foreach_symbol (a_scanner: POINTER; a_scope_id: NATURAL; a_func: POINTER; an_user_data: POINTER) is
	...
	g_scanner_scope_lookup_symbol (a_scanner: POINTER; a_scope_id: NATURAL; a_symbol: POINTER): POINTER is
	...
	g_scanner_scope_remove_symbol (a_scanner: POINTER; a_scope_id: NATURAL; a_symbol: POINTER) is
	...
	g_scanner_set_scope (a_scanner: POINTER; a_scope_id: NATURAL): NATURAL is
 		-- g_scanner_set_scope
		external "plug_in"
		alias "{
			location: "."
	...
	g_scanner_unexp_token (a_scanner: POINTER; an_expected_token: INTEGER; an_identifier_spec: POINTER; a_symbol_spec: POINTER; a_symbol_name: POINTER; a_message: POINTER; an_is_error: INTEGER) is
