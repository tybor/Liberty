...
feature {} -- External calls
	...
	g_sequence_get_iter_at_pos (a_seq: POINTER; a_pos: INTEGER): POINTER is
	...
	g_sequence_get_length (a_seq: POINTER): INTEGER is
	...
	g_sequence_iter_compare (an_a: POINTER; a_b: POINTER): INTEGER is
	...
	g_sequence_iter_get_position (an_iter: POINTER): INTEGER is
	...
	g_sequence_iter_is_begin (an_iter: POINTER): INTEGER is
	...
	g_sequence_iter_is_end (an_iter: POINTER): INTEGER is
	...
	g_sequence_iter_move (an_iter: POINTER; a_delta: INTEGER): POINTER is
	...
	g_sequence_lookup (a_seq: POINTER; a_data: POINTER; a_cmp_func: POINTER; a_cmp_data: POINTER): POINTER is
 		-- g_sequence_lookup
		external "plug_in"
		alias "{
			location: "."
	...
	g_sequence_lookup_iter (a_seq: POINTER; a_data: POINTER; an_iter_cmp: POINTER; a_cmp_data: POINTER): POINTER is
