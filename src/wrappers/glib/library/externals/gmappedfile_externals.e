...
feature {} -- External calls
	...
	g_mapped_file_get_bytes (a_file: POINTER): POINTER is
	...
	g_mapped_file_get_length (a_file: POINTER): NATURAL is
	...
	g_mapped_file_new (a_filename: POINTER; a_writable: INTEGER; an_error: POINTER): POINTER is
 		-- g_mapped_file_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_mapped_file_new_from_fd (a_fd: INTEGER; a_writable: INTEGER; an_error: POINTER): POINTER is
