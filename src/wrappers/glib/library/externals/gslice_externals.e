...
feature {} -- External calls
	...
	g_slice_alloc0 (a_block_size: NATURAL): POINTER is
 		-- g_slice_alloc0
		external "plug_in"
		alias "{
			location: "."
	...
	g_slice_copy (a_block_size: NATURAL; a_mem_block: POINTER): POINTER is
 		-- g_slice_copy
		external "plug_in"
		alias "{
			location: "."
	...
	g_slice_free1 (a_block_size: NATURAL; a_mem_block: POINTER) is
 		-- g_slice_free1
		external "plug_in"
		alias "{
			location: "."
	...
	g_slice_free_chain_with_offset (a_block_size: NATURAL; a_mem_chain: POINTER; a_next_offset: NATURAL) is
