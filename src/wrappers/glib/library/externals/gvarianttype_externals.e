...
feature {} -- External calls
	...
	g_variant_type_equal (a_type1: POINTER; a_type2: POINTER): INTEGER is
	...
	g_variant_type_get_string_length (a_type: POINTER): NATURAL is
	...
	g_variant_type_hash (a_type: POINTER): NATURAL is
 		-- g_variant_type_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_type_is_array (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_basic (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_container (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_definite (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_dict_entry (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_maybe (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_subtype_of (a_type: POINTER; a_supertype: POINTER): INTEGER is
	...
	g_variant_type_is_tuple (a_type: POINTER): INTEGER is
	...
	g_variant_type_is_variant (a_type: POINTER): INTEGER is
	...
	g_variant_type_n_items (a_type: POINTER): NATURAL is
	...
	g_variant_type_new_tuple (an_items: POINTER; a_length: INTEGER): POINTER is
	...
	g_variant_type_string_is_valid (a_type_string: POINTER): INTEGER is
	...
	g_variant_type_string_scan (a_string: POINTER; a_limit: POINTER; an_endptr: POINTER): INTEGER is
