...
feature {} -- External calls
	...
	g_variant_builder_add_parsed (a_builder: POINTER; a_format: POINTER) is
	...
	g_variant_check_format_string (a_value: POINTER; a_format_string: POINTER; a_copy_only: INTEGER): INTEGER is
	...
	g_variant_compare (an_one: POINTER; a_two: POINTER): INTEGER is
 		-- g_variant_compare
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_dup_bytestring (a_value: POINTER; a_length: POINTER): POINTER is
	...
	g_variant_dup_bytestring_array (a_value: POINTER; a_length: POINTER): POINTER is
	...
	g_variant_dup_objv (a_value: POINTER; a_length: POINTER): POINTER is
 		-- g_variant_dup_objv
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_equal (an_one: POINTER; a_two: POINTER): INTEGER is
 		-- g_variant_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_get_boolean (a_value: POINTER): INTEGER is
	...
	g_variant_get_bytestring (a_value: POINTER): POINTER is
	...
	g_variant_get_bytestring_array (a_value: POINTER; a_length: POINTER): POINTER is
	...
	g_variant_get_child (a_value: POINTER; an_index: NATURAL; a_format_string: POINTER) is
	...
	g_variant_get_child_value (a_value: POINTER; an_index: NATURAL): POINTER is
	...
	g_variant_get_double (a_value: POINTER): REAL is
	...
	g_variant_get_fixed_array (a_value: POINTER; a_n_elements: POINTER; an_element_size: NATURAL): POINTER is
	...
	g_variant_get_handle (a_value: POINTER): INTEGER is
	...
	g_variant_get_int32 (a_value: POINTER): INTEGER is
 		-- g_variant_get_int32
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_get_objv (a_value: POINTER; a_length: POINTER): POINTER is
 		-- g_variant_get_objv
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_get_size (a_value: POINTER): NATURAL is
 		-- g_variant_get_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_get_uint32 (a_value: POINTER): NATURAL is
	...
	g_variant_hash (a_value: POINTER): NATURAL is
 		-- g_variant_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_is_container (a_value: POINTER): INTEGER is
	...
	g_variant_is_floating (a_value: POINTER): INTEGER is
	...
	g_variant_is_normal_form (a_value: POINTER): INTEGER is
	...
	g_variant_is_object_path (a_string: POINTER): INTEGER is
	...
	g_variant_is_of_type (a_value: POINTER; a_type: POINTER): INTEGER is
	...
	g_variant_is_signature (a_string: POINTER): INTEGER is
	...
	g_variant_iter_init (an_iter: POINTER; a_value: POINTER): NATURAL is
 		-- g_variant_iter_init
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_iter_loop (an_iter: POINTER; a_format_string: POINTER): INTEGER is
	...
	g_variant_iter_n_children (an_iter: POINTER): NATURAL is
	...
	g_variant_iter_next (an_iter: POINTER; a_format_string: POINTER): INTEGER is
	...
	g_variant_lookup (a_dictionary: POINTER; a_key: POINTER; a_format_string: POINTER): INTEGER is
	...
	g_variant_lookup_value (a_dictionary: POINTER; a_key: POINTER; an_expected_type: POINTER): POINTER is
	...
	g_variant_n_children (a_value: POINTER): NATURAL is
	...
	g_variant_new_array (a_child_type: POINTER; a_children: POINTER; a_n_children: NATURAL): POINTER is
 		-- g_variant_new_array
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_boolean (a_value: INTEGER): POINTER is
	...
	g_variant_new_byte (a_value: CHARACTER): POINTER is
 		-- g_variant_new_byte
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_bytestring (a_string: POINTER): POINTER is
	...
	g_variant_new_bytestring_array (a_strv: POINTER; a_length: INTEGER): POINTER is
	...
	g_variant_new_double (a_value: REAL): POINTER is
	...
	g_variant_new_fixed_array (an_element_type: POINTER; an_elements: POINTER; a_n_elements: NATURAL; an_element_size: NATURAL): POINTER is
	...
	g_variant_new_from_data (a_type: POINTER; a_data: POINTER; a_size: NATURAL; a_trusted: INTEGER; a_notify: POINTER; an_user_data: POINTER): POINTER is
	...
	g_variant_new_handle (a_value: INTEGER): POINTER is
	...
	g_variant_new_int16 (a_value: INTEGER_16): POINTER is
 		-- g_variant_new_int16
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_int32 (a_value: INTEGER): POINTER is
 		-- g_variant_new_int32
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_int64 (a_value: INTEGER_64): POINTER is
 		-- g_variant_new_int64
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_objv (a_strv: POINTER; a_length: INTEGER): POINTER is
 		-- g_variant_new_objv
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_strv (a_strv: POINTER; a_length: INTEGER): POINTER is
 		-- g_variant_new_strv
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_tuple (a_children: POINTER; a_n_children: NATURAL): POINTER is
 		-- g_variant_new_tuple
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_uint16 (a_value: NATURAL_16): POINTER is
	...
	g_variant_new_uint32 (a_value: NATURAL): POINTER is
	...
	g_variant_new_uint64 (a_value: NATURAL_64): POINTER is
	...
	g_variant_parser_get_error_quark: NATURAL is
	...
	g_variant_print (a_value: POINTER; a_type_annotate: INTEGER): POINTER is
 		-- g_variant_print
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_print_string (a_value: POINTER; a_string: POINTER; a_type_annotate: INTEGER): POINTER is
	...
	g_variant_take_ref (a_value: POINTER): POINTER is
 		-- g_variant_take_ref
		external "plug_in"
		alias "{
			location: "."
