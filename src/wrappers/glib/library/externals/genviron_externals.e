...
feature {} -- External calls
	...
	g_environ_setenv (an_envp: POINTER; a_variable: POINTER; a_value: POINTER; an_overwrite: INTEGER): POINTER is
 		-- g_environ_setenv
		external "plug_in"
		alias "{
			location: "."
	...
	g_setenv (a_variable: POINTER; a_value: POINTER; an_overwrite: INTEGER): INTEGER is
 		-- g_setenv
		external "plug_in"
		alias "{
			location: "."
