...
feature {} -- External calls
	...
	g_log_remove_handler (a_log_domain: POINTER; a_handler_id: NATURAL) is
	...
	g_log_set_handler (a_log_domain: POINTER; a_log_levels: INTEGER; a_log_func: POINTER; an_user_data: POINTER): NATURAL is
 		-- g_log_set_handler
		external "plug_in"
		alias "{
			location: "."
	...
	g_printf_string_upper_bound (a_format: POINTER; an_args: POINTER): NATURAL is
	...
	g_warn_message (a_domain: POINTER; a_file: POINTER; a_line: INTEGER; a_func: POINTER; a_warnexpr: POINTER) is
 		-- g_warn_message
		external "plug_in"
		alias "{
			location: "."
