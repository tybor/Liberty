...
feature {} -- External calls
	...
	g_list_copy_deep (a_list: POINTER; a_func: POINTER; an_user_data: POINTER): POINTER is
 		-- g_list_copy_deep
		external "plug_in"
		alias "{
			location: "."
	...
	g_list_free_full (a_list: POINTER; a_free_func: POINTER) is
 		-- g_list_free_full
		external "plug_in"
		alias "{
			location: "."
	...
	g_list_length (a_list: POINTER): NATURAL is
 		-- g_list_length
		external "plug_in"
		alias "{
			location: "."
	...
	g_list_nth (a_list: POINTER; a_n: NATURAL): POINTER is
 		-- g_list_nth
		external "plug_in"
		alias "{
			location: "."
	...
	g_list_nth_data (a_list: POINTER; a_n: NATURAL): POINTER is
 		-- g_list_nth_data
		external "plug_in"
		alias "{
			location: "."
	...
	g_list_nth_prev (a_list: POINTER; a_n: NATURAL): POINTER is
 		-- g_list_nth_prev
		external "plug_in"
		alias "{
			location: "."
