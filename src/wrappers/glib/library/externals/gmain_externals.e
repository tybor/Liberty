...
feature {} -- External calls
	...
	g_child_watch_add (a_pid: INTEGER; a_function: POINTER; a_data: POINTER): NATURAL is
 		-- g_child_watch_add
		external "plug_in"
		alias "{
			location: "."
	...
	g_child_watch_add_full (a_priority: INTEGER; a_pid: INTEGER; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
	...
	-- Variable g_child_watch_funcs (at line 488 in file /usr/include/glib-2.0/glib/gmain.h does not have a wrapper type
	address_of_g_child_watch_funcs: POINTER is
	...
	g_child_watch_source_new (a_pid: INTEGER): POINTER is
	...
	g_get_monotonic_time: INTEGER_64 is
	...
	g_idle_add (a_function: POINTER; a_data: POINTER): NATURAL is
 		-- g_idle_add
		external "plug_in"
		alias "{
			location: "."
	...
	g_idle_add_full (a_priority: INTEGER; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
 		-- g_idle_add_full
		external "plug_in"
		alias "{
			location: "."
	...
	-- Variable g_idle_funcs (at line 489 in file /usr/include/glib-2.0/glib/gmain.h does not have a wrapper type
	address_of_g_idle_funcs: POINTER is
	...
	g_idle_remove_by_data (a_data: POINTER): INTEGER is
	...
	g_main_context_add_poll (a_context: POINTER; a_fd: POINTER; a_priority: INTEGER) is
	...
	g_main_context_check (a_context: POINTER; a_max_priority: INTEGER; a_fds: POINTER; a_n_fds: INTEGER): INTEGER is
	...
	g_main_context_find_source_by_id (a_context: POINTER; a_source_id: NATURAL): POINTER is
	...
	g_main_context_invoke (a_context: POINTER; a_function: POINTER; a_data: POINTER) is
	...
	g_main_context_invoke_full (a_context: POINTER; a_priority: INTEGER; a_function: POINTER; a_data: POINTER; a_notify: POINTER) is
	...
	g_main_context_is_owner (a_context: POINTER): INTEGER is
	...
	g_main_context_iteration (a_context: POINTER; a_may_block: INTEGER): INTEGER is
	...
	g_main_context_prepare (a_context: POINTER; a_priority: POINTER): INTEGER is
	...
	g_main_context_query (a_context: POINTER; a_max_priority: INTEGER; a_timeout: POINTER; a_fds: POINTER; a_n_fds: INTEGER): INTEGER is
	...
	g_main_context_ref_thread_default: POINTER is
	...
	g_main_context_wait (a_context: POINTER; a_cond: POINTER; a_mutex: POINTER): INTEGER is
 		-- g_main_context_wait
		external "plug_in"
		alias "{
			location: "."
	...
	g_main_loop_is_running (a_loop_external: POINTER): INTEGER is
	...
	g_main_loop_new (a_context: POINTER; an_is_running: INTEGER): POINTER is
 		-- g_main_loop_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_add_child_source (a_source: POINTER; a_child_source: POINTER) is
	...
	g_source_attach (a_source: POINTER; a_context: POINTER): NATURAL is
 		-- g_source_attach
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_get_id (a_source: POINTER): NATURAL is
 		-- g_source_get_id
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_get_name (a_source: POINTER): POINTER is
 		-- g_source_get_name
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_get_time (a_source: POINTER): INTEGER_64 is
 		-- g_source_get_time
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_is_destroyed (a_source: POINTER): INTEGER is
	...
	g_source_new (a_source_funcs: POINTER; a_struct_size: NATURAL): POINTER is
 		-- g_source_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_remove (a_tag: NATURAL): INTEGER is
 		-- g_source_remove
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_remove_by_funcs_user_data (a_funcs: POINTER; an_user_data: POINTER): INTEGER is
	...
	g_source_remove_by_user_data (an_user_data: POINTER): INTEGER is
	...
	g_source_remove_child_source (a_source: POINTER; a_child_source: POINTER) is
	...
	g_source_set_can_recurse (a_source: POINTER; a_can_recurse: INTEGER) is
	...
	g_source_set_name (a_source: POINTER; a_name: POINTER) is
 		-- g_source_set_name
		external "plug_in"
		alias "{
			location: "."
	...
	g_source_set_name_by_id (a_tag: NATURAL; a_name: POINTER) is
	...
	g_timeout_add (an_interval: NATURAL; a_function: POINTER; a_data: POINTER): NATURAL is
 		-- g_timeout_add
		external "plug_in"
		alias "{
			location: "."
	...
	g_timeout_add_full (a_priority: INTEGER; an_interval: NATURAL; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
 		-- g_timeout_add_full
		external "plug_in"
		alias "{
			location: "."
	...
	g_timeout_add_seconds (an_interval: NATURAL; a_function: POINTER; a_data: POINTER): NATURAL is
	...
	g_timeout_add_seconds_full (a_priority: INTEGER; an_interval: NATURAL; a_function: POINTER; a_data: POINTER; a_notify: POINTER): NATURAL is
	...
	-- Variable g_timeout_funcs (at line 487 in file /usr/include/glib-2.0/glib/gmain.h does not have a wrapper type
	address_of_g_timeout_funcs: POINTER is
	...
	g_timeout_source_new (an_interval: NATURAL): POINTER is
	...
	g_timeout_source_new_seconds (an_interval: NATURAL): POINTER is
