...
feature {} -- External calls
	...
	g_tree_lookup_extended (a_tree: POINTER; a_lookup_key: POINTER; an_orig_key: POINTER; a_value: POINTER): INTEGER is
	...
	g_tree_remove (a_tree: POINTER; a_key: POINTER): INTEGER is
 		-- g_tree_remove
		external "plug_in"
		alias "{
			location: "."
	...
	g_tree_steal (a_tree: POINTER; a_key: POINTER): INTEGER is
 		-- g_tree_steal
		external "plug_in"
		alias "{
			location: "."
