...
feature {} -- Low-level setters
	...
	gtime_val_struct_set_tv_sec (a_structure: POINTER; a_value: like long) is
	...
	gtime_val_struct_set_tv_usec (a_structure: POINTER; a_value: like long) is
...
feature {} -- Low-level queries
	...
	gtime_val_struct_get_tv_sec (a_structure: POINTER): like long is
	...
	gtime_val_struct_get_tv_usec (a_structure: POINTER): like long is
