...
feature {} -- External calls
	...
	g_convert_error_quark: NATURAL is
	...
	g_convert_with_fallback (a_str: POINTER; a_len: INTEGER; a_to_codeset: POINTER; a_from_codeset: POINTER; a_fallback: POINTER; a_bytes_read: POINTER; a_bytes_written: POINTER; an_error: POINTER): POINTER is
	...
	g_convert_with_iconv (a_str: POINTER; a_len: INTEGER; a_converter: POINTER; a_bytes_read: POINTER; a_bytes_written: POINTER; an_error: POINTER): POINTER is
	...
	g_filename_from_utf8 (an_utf8string: POINTER; a_len: INTEGER; a_bytes_read: POINTER; a_bytes_written: POINTER; an_error: POINTER): POINTER is
	...
	g_filename_to_utf8 (an_opsysstring: POINTER; a_len: INTEGER; a_bytes_read: POINTER; a_bytes_written: POINTER; an_error: POINTER): POINTER is
 		-- g_filename_to_utf8
		external "plug_in"
		alias "{
			location: "."
	...
	g_get_filename_charsets (a_charsets: POINTER): INTEGER is
	...
	g_iconv (a_converter: POINTER; an_inbuf: POINTER; an_inbytes_left: POINTER; an_outbuf: POINTER; an_outbytes_left: POINTER): NATURAL is
 		-- g_iconv
		external "plug_in"
		alias "{
			location: "."
	...
	g_iconv_close (a_converter: POINTER): INTEGER is
 		-- g_iconv_close
		external "plug_in"
		alias "{
			location: "."
	...
	g_locale_from_utf8 (an_utf8string: POINTER; a_len: INTEGER; a_bytes_read: POINTER; a_bytes_written: POINTER; an_error: POINTER): POINTER is
 		-- g_locale_from_utf8
		external "plug_in"
		alias "{
			location: "."
	...
	g_locale_to_utf8 (an_opsysstring: POINTER; a_len: INTEGER; a_bytes_read: POINTER; a_bytes_written: POINTER; an_error: POINTER): POINTER is
 		-- g_locale_to_utf8
		external "plug_in"
		alias "{
			location: "."
