...
feature {} -- Low-level setters
	...
	gmarkup_parser_struct_set_start_element (a_structure: POINTER; a_value: POINTER) is
	...
	gmarkup_parser_struct_set_end_element (a_structure: POINTER; a_value: POINTER) is
	...
	gmarkup_parser_struct_set_text (a_structure: POINTER; a_value: POINTER) is
	...
	gmarkup_parser_struct_set_passthrough (a_structure: POINTER; a_value: POINTER) is
	...
	gmarkup_parser_struct_set_error (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	gmarkup_parser_struct_get_start_element (a_structure: POINTER): POINTER is
	...
	gmarkup_parser_struct_get_end_element (a_structure: POINTER): POINTER is
	...
	gmarkup_parser_struct_get_text (a_structure: POINTER): POINTER is
	...
	gmarkup_parser_struct_get_passthrough (a_structure: POINTER): POINTER is
	...
	gmarkup_parser_struct_get_error (a_structure: POINTER): POINTER is
