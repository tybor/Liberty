...
feature {} -- External calls
	...
	g_hook_destroy (a_hook_list: POINTER; a_hook_id: like long_unsigned): INTEGER is
 		-- g_hook_destroy
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_find (a_hook_list: POINTER; a_need_valids: INTEGER; a_func: POINTER; a_data: POINTER): POINTER is
 		-- g_hook_find
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_find_data (a_hook_list: POINTER; a_need_valids: INTEGER; a_data: POINTER): POINTER is
 		-- g_hook_find_data
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_find_func (a_hook_list: POINTER; a_need_valids: INTEGER; a_func: POINTER): POINTER is
 		-- g_hook_find_func
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_find_func_data (a_hook_list: POINTER; a_need_valids: INTEGER; a_func: POINTER; a_data: POINTER): POINTER is
	...
	g_hook_first_valid (a_hook_list: POINTER; a_may_be_in_call: INTEGER): POINTER is
 		-- g_hook_first_valid
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_get (a_hook_list: POINTER; a_hook_id: like long_unsigned): POINTER is
 		-- g_hook_get
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_list_init (a_hook_list: POINTER; a_hook_size: NATURAL) is
 		-- g_hook_list_init
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_list_invoke (a_hook_list: POINTER; a_may_recurse: INTEGER) is
 		-- g_hook_list_invoke
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_list_invoke_check (a_hook_list: POINTER; a_may_recurse: INTEGER) is
	...
	g_hook_list_marshal (a_hook_list: POINTER; a_may_recurse: INTEGER; a_marshaller: POINTER; a_marshal_data: POINTER) is
 		-- g_hook_list_marshal
		external "plug_in"
		alias "{
			location: "."
	...
	g_hook_list_marshal_check (a_hook_list: POINTER; a_may_recurse: INTEGER; a_marshaller: POINTER; a_marshal_data: POINTER) is
	...
	g_hook_next_valid (a_hook_list: POINTER; a_hook: POINTER; a_may_be_in_call: INTEGER): POINTER is
 		-- g_hook_next_valid
		external "plug_in"
		alias "{
			location: "."
