...
feature {} -- Low-level setters
	...
	ghook_struct_set_ref_count (a_structure: POINTER; a_value: NATURAL) is
	...
	ghook_struct_set_hook_id (a_structure: POINTER; a_value: like long_unsigned) is
	...
	ghook_struct_set_flags (a_structure: POINTER; a_value: NATURAL) is
...
feature {} -- Low-level queries
	...
	ghook_struct_get_ref_count (a_structure: POINTER): NATURAL is
	...
	ghook_struct_get_hook_id (a_structure: POINTER): like long_unsigned is
	...
	ghook_struct_get_flags (a_structure: POINTER): NATURAL is
