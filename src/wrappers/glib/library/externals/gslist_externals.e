...
feature {} -- External calls
	...
	g_slist_copy_deep (a_list: POINTER; a_func: POINTER; an_user_data: POINTER): POINTER is
 		-- g_slist_copy_deep
		external "plug_in"
		alias "{
			location: "."
	...
	g_slist_free_full (a_list: POINTER; a_free_func: POINTER) is
 		-- g_slist_free_full
		external "plug_in"
		alias "{
			location: "."
	...
	g_slist_length (a_list: POINTER): NATURAL is
 		-- g_slist_length
		external "plug_in"
		alias "{
			location: "."
	...
	g_slist_nth (a_list: POINTER; a_n: NATURAL): POINTER is
 		-- g_slist_nth
		external "plug_in"
		alias "{
			location: "."
	...
	g_slist_nth_data (a_list: POINTER; a_n: NATURAL): POINTER is
 		-- g_slist_nth_data
		external "plug_in"
		alias "{
			location: "."
