...
feature {} -- Low-level setters
	...
	gtest_log_buffer_struct_set_data (a_structure: POINTER; a_value: POINTER) is
	...
	gtest_log_buffer_struct_set_msgs (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	gtest_log_buffer_struct_get_data (a_structure: POINTER): POINTER is
	...
	gtest_log_buffer_struct_get_msgs (a_structure: POINTER): POINTER is
