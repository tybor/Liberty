...
feature {} -- Low-level setters
	...
	gpoll_fd_struct_set_fd (a_structure: POINTER; a_value: INTEGER) is
	...
	gpoll_fd_struct_set_events (a_structure: POINTER; a_value: NATURAL_16) is
	...
	gpoll_fd_struct_set_revents (a_structure: POINTER; a_value: NATURAL_16) is
...
feature {} -- Low-level queries
	...
	gpoll_fd_struct_get_fd (a_structure: POINTER): INTEGER is
	...
	gpoll_fd_struct_get_events (a_structure: POINTER): NATURAL_16 is
	...
	gpoll_fd_struct_get_revents (a_structure: POINTER): NATURAL_16 is
