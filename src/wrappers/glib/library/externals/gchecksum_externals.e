...
feature {} -- External calls
	...
	g_checksum_type_get_length (a_checksum_type: INTEGER): INTEGER is
	...
	g_checksum_update (a_checksum: POINTER; a_data: POINTER; a_length: INTEGER) is
 		-- g_checksum_update
		external "plug_in"
		alias "{
			location: "."
	...
	g_compute_checksum_for_bytes (a_checksum_type: INTEGER; a_data: POINTER): POINTER is
	...
	g_compute_checksum_for_data (a_checksum_type: INTEGER; a_data: POINTER; a_length: NATURAL): POINTER is
	...
	g_compute_checksum_for_string (a_checksum_type: INTEGER; a_str: POINTER; a_length: INTEGER): POINTER is
