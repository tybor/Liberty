...
feature {} -- External calls
	...
	g_queue_free_full (a_queue: POINTER; a_free_func: POINTER) is
 		-- g_queue_free_full
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_get_length (a_queue: POINTER): NATURAL is
 		-- g_queue_get_length
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_index (a_queue: POINTER; a_data: POINTER): INTEGER is
 		-- g_queue_index
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_is_empty (a_queue: POINTER): INTEGER is
 		-- g_queue_is_empty
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_link_index (a_queue: POINTER; a_link: POINTER): INTEGER is
 		-- g_queue_link_index
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_peek_nth (a_queue: POINTER; a_n: NATURAL): POINTER is
 		-- g_queue_peek_nth
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_peek_nth_link (a_queue: POINTER; a_n: NATURAL): POINTER is
	...
	g_queue_pop_nth (a_queue: POINTER; a_n: NATURAL): POINTER is
 		-- g_queue_pop_nth
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_pop_nth_link (a_queue: POINTER; a_n: NATURAL): POINTER is
	...
	g_queue_push_nth (a_queue: POINTER; a_data: POINTER; a_n: INTEGER) is
 		-- g_queue_push_nth
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_push_nth_link (a_queue: POINTER; a_n: INTEGER; a_link: POINTER) is
	...
	g_queue_remove (a_queue: POINTER; a_data: POINTER): INTEGER is
 		-- g_queue_remove
		external "plug_in"
		alias "{
			location: "."
	...
	g_queue_remove_all (a_queue: POINTER; a_data: POINTER): NATURAL is
 		-- g_queue_remove_all
		external "plug_in"
		alias "{
			location: "."
