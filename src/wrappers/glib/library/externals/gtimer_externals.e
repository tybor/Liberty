...
feature {} -- External calls
	...
	g_time_val_from_iso8601 (an_iso_date: POINTER; a_time: POINTER): INTEGER is
	...
	g_timer_elapsed (a_timer: POINTER; a_microseconds: POINTER): REAL is
 		-- g_timer_elapsed
		external "plug_in"
		alias "{
			location: "."
	...
	g_usleep (a_microseconds: like long_unsigned) is
 		-- g_usleep
		external "plug_in"
		alias "{
			location: "."
