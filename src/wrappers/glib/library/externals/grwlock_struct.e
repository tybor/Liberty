...
feature {} -- Low-level setters
	...
	grwlock_struct_set_p (a_structure: POINTER; a_value: POINTER) is
	...
	grwlock_struct_set_i (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	grwlock_struct_get_p (a_structure: POINTER): POINTER is
	...
	grwlock_struct_get_i (a_structure: POINTER): POINTER is
