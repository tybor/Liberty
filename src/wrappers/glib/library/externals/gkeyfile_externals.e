...
feature {} -- External calls
	...
	g_key_file_error_quark: NATURAL is
	...
	g_key_file_get_boolean (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): INTEGER is
	...
	g_key_file_get_double (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): REAL is
	...
	g_key_file_get_int64 (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): INTEGER_64 is
	...
	g_key_file_get_integer (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): INTEGER is
	...
	g_key_file_get_uint64 (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): NATURAL_64 is
	...
	g_key_file_has_group (a_key_file: POINTER; a_group_name: POINTER): INTEGER is
	...
	g_key_file_has_key (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): INTEGER is
 		-- g_key_file_has_key
		external "plug_in"
		alias "{
			location: "."
	...
	g_key_file_load_from_data (a_key_file: POINTER; a_data: POINTER; a_length: NATURAL; a_flags: INTEGER; an_error: POINTER): INTEGER is
	...
	g_key_file_load_from_data_dirs (a_key_file: POINTER; a_file: POINTER; a_full_path: POINTER; a_flags: INTEGER; an_error: POINTER): INTEGER is
	...
	g_key_file_load_from_dirs (a_key_file: POINTER; a_file: POINTER; a_search_dirs: POINTER; a_full_path: POINTER; a_flags: INTEGER; an_error: POINTER): INTEGER is
	...
	g_key_file_load_from_file (a_key_file: POINTER; a_file: POINTER; a_flags: INTEGER; an_error: POINTER): INTEGER is
	...
	g_key_file_ref (a_key_file: POINTER): POINTER is
 		-- g_key_file_ref
		external "plug_in"
		alias "{
			location: "."
	...
	g_key_file_remove_comment (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): INTEGER is
	...
	g_key_file_remove_group (a_key_file: POINTER; a_group_name: POINTER; an_error: POINTER): INTEGER is
	...
	g_key_file_remove_key (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; an_error: POINTER): INTEGER is
	...
	g_key_file_set_boolean (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_value: INTEGER) is
	...
	g_key_file_set_boolean_list (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_list: POINTER; a_length: NATURAL) is
	...
	g_key_file_set_comment (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_comment: POINTER; an_error: POINTER): INTEGER is
	...
	g_key_file_set_double (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_value: REAL) is
	...
	g_key_file_set_double_list (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_list: POINTER; a_length: NATURAL) is
	...
	g_key_file_set_int64 (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_value: INTEGER_64) is
	...
	g_key_file_set_integer (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_value: INTEGER) is
	...
	g_key_file_set_integer_list (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_list: POINTER; a_length: NATURAL) is
	...
	g_key_file_set_locale_string_list (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_locale: POINTER; a_list: POINTER; a_length: NATURAL) is
	...
	g_key_file_set_string_list (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_list: POINTER; a_length: NATURAL) is
	...
	g_key_file_set_uint64 (a_key_file: POINTER; a_group_name: POINTER; a_key: POINTER; a_value: NATURAL_64) is
	...
	g_key_file_unref (a_key_file: POINTER) is
 		-- g_key_file_unref
		external "plug_in"
		alias "{
			location: "."
