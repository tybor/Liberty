...
feature {} -- Low-level setters
	...
	gsource_funcs_struct_set_prepare (a_structure: POINTER; a_value: POINTER) is
	...
	gsource_funcs_struct_set_check_field (a_structure: POINTER; a_value: POINTER) is
	...
	gsource_funcs_struct_set_dispatch (a_structure: POINTER; a_value: POINTER) is
	...
	gsource_funcs_struct_set_finalize (a_structure: POINTER; a_value: POINTER) is
	...
	gsource_funcs_struct_set_closure_callback (a_structure: POINTER; a_value: POINTER) is
	...
	gsource_funcs_struct_set_closure_marshal (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	gsource_funcs_struct_get_prepare (a_structure: POINTER): POINTER is
	...
	gsource_funcs_struct_get_check_field (a_structure: POINTER): POINTER is
	...
	gsource_funcs_struct_get_dispatch (a_structure: POINTER): POINTER is
	...
	gsource_funcs_struct_get_finalize (a_structure: POINTER): POINTER is
	...
	gsource_funcs_struct_get_closure_callback (a_structure: POINTER): POINTER is
	...
	gsource_funcs_struct_get_closure_marshal (a_structure: POINTER): POINTER is
