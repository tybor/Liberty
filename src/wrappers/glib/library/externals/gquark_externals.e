...
feature {} -- External calls
	...
	g_quark_from_static_string (a_string: POINTER): NATURAL is
	...
	g_quark_from_string (a_string: POINTER): NATURAL is
 		-- g_quark_from_string
		external "plug_in"
		alias "{
			location: "."
	...
	g_quark_to_string (a_quark: NATURAL): POINTER is
 		-- g_quark_to_string
		external "plug_in"
		alias "{
			location: "."
	...
	g_quark_try_string (a_string: POINTER): NATURAL is
 		-- g_quark_try_string
		external "plug_in"
		alias "{
			location: "."
