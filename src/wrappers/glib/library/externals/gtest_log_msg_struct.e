...
feature {} -- Low-level setters
	...
	gtest_log_msg_struct_set_log_type (a_structure: POINTER; a_value: INTEGER) is
	...
	gtest_log_msg_struct_set_n_strings (a_structure: POINTER; a_value: NATURAL) is
	...
	gtest_log_msg_struct_set_strings (a_structure: POINTER; a_value: POINTER) is
	...
	gtest_log_msg_struct_set_n_nums (a_structure: POINTER; a_value: NATURAL) is
	...
	gtest_log_msg_struct_set_nums (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	gtest_log_msg_struct_get_log_type (a_structure: POINTER): INTEGER is
	...
	gtest_log_msg_struct_get_n_strings (a_structure: POINTER): NATURAL is
	...
	gtest_log_msg_struct_get_strings (a_structure: POINTER): POINTER is
	...
	gtest_log_msg_struct_get_n_nums (a_structure: POINTER): NATURAL is
	...
	gtest_log_msg_struct_get_nums (a_structure: POINTER): POINTER is
