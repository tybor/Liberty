...
feature {} -- External calls
	...
	g_io_add_watch_full (a_channel: POINTER; a_priority: INTEGER; a_condition: INTEGER; a_func: POINTER; an_user_data: POINTER; a_notify: POINTER): NATURAL is
 		-- g_io_add_watch_full
		external "plug_in"
		alias "{
			location: "."
	...
	g_io_channel_error_from_errno (an_en: INTEGER): INTEGER is
	...
	g_io_channel_error_quark: NATURAL is
	...
	g_io_channel_get_buffer_size (a_channel: POINTER): NATURAL is
	...
	g_io_channel_get_buffered (a_channel: POINTER): INTEGER is
	...
	g_io_channel_get_close_on_unref (a_channel: POINTER): INTEGER is
	...
	g_io_channel_read (a_channel: POINTER; a_buf: POINTER; a_count: NATURAL; a_bytes_read: POINTER): INTEGER is
 		-- g_io_channel_read
		external "plug_in"
		alias "{
			location: "."
	...
	g_io_channel_read_chars (a_channel: POINTER; a_buf: POINTER; a_count: NATURAL; a_bytes_read: POINTER; an_error: POINTER): INTEGER is
	...
	g_io_channel_set_buffer_size (a_channel: POINTER; a_size: NATURAL) is
	...
	g_io_channel_set_buffered (a_channel: POINTER; a_buffered: INTEGER) is
	...
	g_io_channel_set_close_on_unref (a_channel: POINTER; a_do_close: INTEGER) is
	...
	g_io_channel_set_line_term (a_channel: POINTER; a_line_term: POINTER; a_length: INTEGER) is
	...
	g_io_channel_shutdown (a_channel: POINTER; a_flush: INTEGER; an_err: POINTER): INTEGER is
	...
	g_io_channel_write (a_channel: POINTER; a_buf: POINTER; a_count: NATURAL; a_bytes_written: POINTER): INTEGER is
 		-- g_io_channel_write
		external "plug_in"
		alias "{
			location: "."
	...
	g_io_channel_write_chars (a_channel: POINTER; a_buf: POINTER; a_count: INTEGER; a_bytes_written: POINTER; an_error: POINTER): INTEGER is
	...
	g_io_channel_write_unichar (a_channel: POINTER; a_thechar: NATURAL; an_error: POINTER): INTEGER is
	...
	-- Variable g_io_watch_funcs (at line 311 in file /usr/include/glib-2.0/glib/giochannel.h does not have a wrapper type
	address_of_g_io_watch_funcs: POINTER is
