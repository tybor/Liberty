...
feature {} -- Low-level setters
	...
	xml_dtd_struct_set_type (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_type"
		}"
		end
	...
	xml_dtd_struct_set_name (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_name"
		}"
		end
	...
	xml_dtd_struct_set_children (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_children"
		}"
		end
	...
	xml_dtd_struct_set_last (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_last"
		}"
		end
	...
	xml_dtd_struct_set_parent (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_parent"
		}"
		end
	...
	xml_dtd_struct_set_next (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_next"
		}"
		end
	...
	xml_dtd_struct_set_prev (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_prev"
		}"
		end
	...
	xml_dtd_struct_set_doc (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_doc"
		}"
		end
	...
	xml_dtd_struct_set_notations (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_notations"
		}"
		end
	...
	xml_dtd_struct_set_elements (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_elements"
		}"
		end
	...
	xml_dtd_struct_set_attributes (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_attributes"
		}"
		end
	...
	xml_dtd_struct_set_entities (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_entities"
		}"
		end
	...
	xml_dtd_struct_set_externalid (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_externalid"
		}"
		end
	...
	xml_dtd_struct_set_systemid (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_systemid"
		}"
		end
	...
	xml_dtd_struct_set_pentities (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_set_pentities"
		}"
		end
...
feature {} -- Low-level queries
	...
	xml_dtd_struct_get_type (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_type"
		}"
		end
	...
	xml_dtd_struct_get_name (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_name"
		}"
		end
	...
	xml_dtd_struct_get_children (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_children"
		}"
		end
	...
	xml_dtd_struct_get_last (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_last"
		}"
		end
	...
	xml_dtd_struct_get_parent (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_parent"
		}"
		end
	...
	xml_dtd_struct_get_next (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_next"
		}"
		end
	...
	xml_dtd_struct_get_prev (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_prev"
		}"
		end
	...
	xml_dtd_struct_get_doc (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_doc"
		}"
		end
	...
	xml_dtd_struct_get_notations (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_notations"
		}"
		end
	...
	xml_dtd_struct_get_elements (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_elements"
		}"
		end
	...
	xml_dtd_struct_get_attributes (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_attributes"
		}"
		end
	...
	xml_dtd_struct_get_entities (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_entities"
		}"
		end
	...
	xml_dtd_struct_get_externalid (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_externalid"
		}"
		end
	...
	xml_dtd_struct_get_systemid (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_systemid"
		}"
		end
	...
	xml_dtd_struct_get_pentities (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_dtd_struct_get_pentities"
		}"
		end
...
feature {WRAPPER, WRAPPER_HANDLER} -- Structure size
	struct_size: like size_t is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "sizeof__xmlDtd"
		}"
		end

end -- class XML_DTD_STRUCT
-- This file have been created by wrapper-generator.
-- Any change will be lost by the next execution of the tool.
