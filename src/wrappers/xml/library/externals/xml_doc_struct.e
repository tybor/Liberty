...
feature {} -- Low-level setters
	...
	xml_doc_struct_set_type (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_type"
		}"
		end
	...
	xml_doc_struct_set_name (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_name"
		}"
		end
	...
	xml_doc_struct_set_children (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_children"
		}"
		end
	...
	xml_doc_struct_set_last (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_last"
		}"
		end
	...
	xml_doc_struct_set_parent (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_parent"
		}"
		end
	...
	xml_doc_struct_set_next (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_next"
		}"
		end
	...
	xml_doc_struct_set_prev (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_prev"
		}"
		end
	...
	xml_doc_struct_set_doc (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_doc"
		}"
		end
	...
	xml_doc_struct_set_compression (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_compression"
		}"
		end
	...
	xml_doc_struct_set_standalone (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_standalone"
		}"
		end
	...
	xml_doc_struct_set_intsubset (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_intsubset"
		}"
		end
	...
	xml_doc_struct_set_extsubset (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_extsubset"
		}"
		end
	...
	xml_doc_struct_set_oldns (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_oldns"
		}"
		end
	...
	xml_doc_struct_set_version (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_version"
		}"
		end
	...
	xml_doc_struct_set_encoding (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_encoding"
		}"
		end
	...
	xml_doc_struct_set_ids (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_ids"
		}"
		end
	...
	xml_doc_struct_set_refs (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_refs"
		}"
		end
	...
	xml_doc_struct_set_url (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_url"
		}"
		end
	...
	xml_doc_struct_set_charset (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_charset"
		}"
		end
	...
	xml_doc_struct_set_dict (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_dict"
		}"
		end
	...
	xml_doc_struct_set_psvi (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_psvi"
		}"
		end
	...
	xml_doc_struct_set_parseflags (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_parseflags"
		}"
		end
	...
	xml_doc_struct_set_properties (a_structure: POINTER; a_value: INTEGER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_set_properties"
		}"
		end
...
feature {} -- Low-level queries
	...
	xml_doc_struct_get_type (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_type"
		}"
		end
	...
	xml_doc_struct_get_name (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_name"
		}"
		end
	...
	xml_doc_struct_get_children (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_children"
		}"
		end
	...
	xml_doc_struct_get_last (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_last"
		}"
		end
	...
	xml_doc_struct_get_parent (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_parent"
		}"
		end
	...
	xml_doc_struct_get_next (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_next"
		}"
		end
	...
	xml_doc_struct_get_prev (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_prev"
		}"
		end
	...
	xml_doc_struct_get_doc (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_doc"
		}"
		end
	...
	xml_doc_struct_get_compression (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_compression"
		}"
		end
	...
	xml_doc_struct_get_standalone (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_standalone"
		}"
		end
	...
	xml_doc_struct_get_intsubset (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_intsubset"
		}"
		end
	...
	xml_doc_struct_get_extsubset (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_extsubset"
		}"
		end
	...
	xml_doc_struct_get_oldns (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_oldns"
		}"
		end
	...
	xml_doc_struct_get_version (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_version"
		}"
		end
	...
	xml_doc_struct_get_encoding (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_encoding"
		}"
		end
	...
	xml_doc_struct_get_ids (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_ids"
		}"
		end
	...
	xml_doc_struct_get_refs (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_refs"
		}"
		end
	...
	xml_doc_struct_get_url (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_url"
		}"
		end
	...
	xml_doc_struct_get_charset (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_charset"
		}"
		end
	...
	xml_doc_struct_get_dict (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_dict"
		}"
		end
	...
	xml_doc_struct_get_psvi (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_psvi"
		}"
		end
	...
	xml_doc_struct_get_parseflags (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_parseflags"
		}"
		end
	...
	xml_doc_struct_get_properties (a_structure: POINTER): INTEGER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "xml_doc_struct_get_properties"
		}"
		end
...
feature {WRAPPER, WRAPPER_HANDLER} -- Structure size
	struct_size: like size_t is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "sizeof__xmlDoc"
		}"
		end

end -- class XML_DOC_STRUCT
-- This file have been created by wrapper-generator.
-- Any change will be lost by the next execution of the tool.
