...
feature {} -- Low-level setters
	...
	xlink_handler_struct_set_simple (a_structure: POINTER; a_value: POINTER) is
	...
	xlink_handler_struct_set_extended (a_structure: POINTER; a_value: POINTER) is
	...
	xlink_handler_struct_set_set (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	xlink_handler_struct_get_simple (a_structure: POINTER): POINTER is
	...
	xlink_handler_struct_get_extended (a_structure: POINTER): POINTER is
	...
	xlink_handler_struct_get_set (a_structure: POINTER): POINTER is
